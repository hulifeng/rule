        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-body" style="position: relative;">
                    <form class="layui-form" method="post" action="{{route('rules.store_new')}}">
                        {{ csrf_field() }}
                        ...
                        <div id="template_main" class="layui-hide">
                            <div class="layui-form-item">
                                ...
                                <div id="use_object" class="layui-btn-group">
                                    <input type="hidden" name="rule_object" id="rule-object" value="1">
                            ...
                            <div class="layui-form-item layui-hide" id="choose_plan">
                                ...
                                <div class="layui-input-block" style="width: 212px;">
                                    <select name="ad_id" id="ad_id" lay-search>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline" style="width: 100px; margin-right: 0;">
                                        <input type="text" class="layui-input" name="execute_val">
                                    </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-inline">
                                        <input type="text" class="layui-input" name="clock">
                                </div>
                                <div class="layui-inline">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block" style="width: 212px;">
                                    <input type="text" class="layui-input" name="rule_name" lay-verify="rule_name">
                                </div>
                            </div>
